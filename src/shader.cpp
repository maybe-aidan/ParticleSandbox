...
void Shader::setFloatArray(const std::string &name, int size, const float* data) const {
    glUniform1fv(glGetUniformLocation(ID, name.c_str()), size, data);
}
void Shader::setFloat3Array(const std::string &name, int size, const float* data) const {
